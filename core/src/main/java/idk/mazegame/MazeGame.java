...
public class MazeGame extends Game {
	...
	private String[] roomList = {"saferoom", "testroom", "forestroom", "lake", "cave", "barren", "dirtpatch", "path", "plain", "crossroads"};
	private int level1;
	private int level2;
	...
	public void render() {
		...
		if(xp1Increased || xp2Increased)
		{
			...
			if(xp1Increased && xp2Increased)
			{
				...
				font.draw(renderer.getBatch(), xpText, 107.5f, 26.5f,screenWidth, Align.topLeft, false);	
			}
			else
			{
				if(xp1Increased)
